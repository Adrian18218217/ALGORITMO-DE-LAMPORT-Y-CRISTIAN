...
public class Main extends Thread {
	public static void main(String[] args) {
		...
		P2.start();
		P3.start();
		//IMPRIMIR LISTA DE PROCESOS CON SUS EVENTOS
		for(int x=0;x<10;x++) {
		...
		//IMPRIMIMOS LA LISTA DE EVENTOS VERDADEROS
...
class Proces extends Thread {
	// DEBE TENER UN ARRAY DE MENSAJES
